...
inspre_mask_function <- function(X){
  ...
  res <- inspre(
    S_hat, verbose = 1, nlambda = nlambda, lambda_min_ratio = lambda_min_ratio,
...
save(plot_tibble_1, file = "/home/brielin/Work/inspre/plot_data/inspre_sim_1.Rdata")
```
...
save(plot_tibble_2, file = "/home/brielin/Work/inspre/plot_data/inspre_sim_2.Rdata")
```
...
save(plot_tibble_3, file = "/home/brielin/Work/inspre/plot_data/inspre_sim_2.Rdata")
```
...
save(plot_tibble_4, file = "/home/brielin/Work/inspre/plot_data/inspre_sim_1.Rdata")
```
...
save(plot_tibble_5, file = "/home/brielin/Work/inspre/plot_data/inspre_sim_2.Rdata")
```
...
save(plot_tibble_6, file = "/home/brielin/Work/inspre/plot_data/inspre_sim_2.Rdata")
```
...
save(plot_tibble_7, file = "/home/brielin/Work/inspre/plot_data/inspre_sim_1.Rdata")
```
...
save(plot_tibble_8, file = "/home/brielin/Work/inspre/plot_data/inspre_sim_2.Rdata")
```
...
save(plot_tibble_9, file = "/home/brielin/Work/inspre/plot_data/inspre_sim_2.Rdata")
```
