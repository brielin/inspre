...
cis_trans_fn <- "/gpfs/commons/groups/knowles_lab/gwps/saved_rdata/cis_trans.csv"
cis_trans <- readr::read_csv(cis_trans_fn)
...
# Calculate p-val per gene (random graph)
...
```{r}
load('/gpfs/commons/groups/knowles_lab/gwps/saved_rdata/G_res.Rdata')
load('/gpfs/commons/groups/knowles_lab/gwps/saved_rdata/perm_res.Rdata')
load('/gpfs/commons/groups/knowles_lab/gwps/saved_rdata/rand_res.Rdata')
```
...
save(rand_res_gwps, file='/gpfs/commons/groups/knowles_lab/gwps/saved_rdata/rand_res_gwps_2.Rdata')
...
# Calculate p-val per gene (random edges)
G_res_gwps$p_gene_r2_edge <- rowMeans(G_res_gwps$r2 < rand_res)
...
```{r}
load('/gpfs/commons/groups/knowles_lab/gwps/saved_rdata/G_res_gwps.Rdata')
load('/gpfs/commons/groups/knowles_lab/gwps/saved_rdata/perm_res_gwps.Rdata')
```
